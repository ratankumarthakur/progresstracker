...
class cns extends StatefulWidget {
  const cns({super.key});
  @override
  State<cns> createState() => _cnsState();
}

class _cnsState extends State<cns> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar:
      utility.app_bar(context, c, "Cryptography and Network Security"),
      floatingActionButton: utility.floating_action(
          ...
          "https://docs.google.com/document/d/1LmVpwDrw_5uGCJ8VoVSZYgyD84Rd6mr8EmwxInseEyU/edit?usp=sharing",
      ...
      body: Column(
        children: [
            ...
            Padding(
              ...
              child: Column(
                children: [
                  ...
                  ElevatedButton(
                    onPressed: () {
                      utility.submitData(_controller, _showTextField, 'cns');
                      setState(() {
          ...
          utility.show_data(context, 'cns', c, Colors.orange.shade200, _selectedDate, _searchText)
        ],
      ),
    );
  }
