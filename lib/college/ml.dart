...
class _mlState extends State<ml> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar:
      utility.app_bar(context, c, "Machine Learning"),
      floatingActionButton: utility.floating_action(
          ...
          "https://docs.google.com/document/d/1JZspage66hu_HeE7ly6pOTL0zwgrQArKxmvtNQNW30g/edit?usp=sharing",
      ...
      body: Column(
        children: [
            ...
            Padding(
              ...
              child: Column(
                children: [
                  ...
                  ElevatedButton(
                    onPressed: () {
                      utility.submitData(_controller, _showTextField, 'ml');
                      setState(() {
          ...
          utility.show_data(context, 'ml', c, Colors.purple.shade200, _selectedDate, _searchText)
        ],
      ),
    );
  }
