...
class gfg extends StatefulWidget {
  @override
  _gfgState createState() => _gfgState();
}
...
class _gfgState extends State<gfg> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: utility.app_bar(context, c, "Geeks For Geeks"),
      body: Column(
        children: [
          Padding(
            padding:
                  ...
                  ElevatedButton(
                    onPressed: () {
                      utility.saveData(_textController, _youtubeUrlController,
                          _problemLinkController, _isFormVisible, 'gfg');
                      setState(() {
          ...
          utility.show_data_coding(context, 'gfg', Color(0xfffaae2a),
              Color(0xffffd285), _selectedDate, _searchText),
          Card(
            margin: EdgeInsets.all(16),
            child: ListTile(
              hoverColor: Color(0xfffaae2a),
              title: Center(child: Text('Visit Geeks For Geeks')),
              trailing: Icon(Icons.open_in_new),
              onTap: () =>
                  utility.launchURL('https://www.geeksforgeeks.org/user/ratankumartgsq2/'),
            ),
          ),
        ],
      ),
