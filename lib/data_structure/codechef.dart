...
class _codechefState extends State<codechef> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: utility.app_bar(context, c, "Codechef"),
      body: Column(
        children: [
          Padding(
            padding:
                  ...
                  ElevatedButton(
                    onPressed: () {
                      utility.saveData(_textController, _youtubeUrlController,
                          _problemLinkController, _isFormVisible, 'codechef');
                      setState(() {
          ...
          utility.show_data_coding(context, 'codechef', Color(0xfffaae2a),
              Color(0xffffd285), _selectedDate, _searchText),
          Card(
            margin: EdgeInsets.all(16),
            child: ListTile(
              hoverColor: Color(0xfffaae2a),
              title: Center(child: Text('Visit Codechef')),
              trailing: Icon(Icons.open_in_new),
              onTap: () =>
                  utility.launchURL('https://www.codechef.com/users/ratan_25'),
            ),
          ),
        ],
      ),
