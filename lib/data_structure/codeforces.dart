...
class _codeforcesState extends State<codeforces> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: utility.app_bar(context, c, "Codeforces"),
      body: Column(
        children: [
          Padding(
            padding:
                  ...
                  ElevatedButton(
                    onPressed: () {
                      utility.saveData(_textController, _youtubeUrlController,
                          _problemLinkController, _isFormVisible, 'codeforces');
                      setState(() {
          ...
          utility.show_data_coding(context, 'codeforces', Color(0xfffaae2a),
              Color(0xffffd285), _selectedDate, _searchText),
          Card(
            margin: EdgeInsets.all(16),
            child: ListTile(
              hoverColor: Color(0xfffaae2a),
              title: Center(child: Text('Visit Codeforces')),
              trailing: Icon(Icons.open_in_new),
              onTap: () =>
                  utility.launchURL('https://codeforces.com/profile/Ratan_Kumar_Thakur'),
            ),
          ),
        ],
      ),
