...
class coding_ninja extends StatefulWidget {
  @override
  _coding_ninjaState createState() => _coding_ninjaState();
}

class _coding_ninjaState extends State<coding_ninja> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: utility.app_bar(context, c, "Coding Ninja"),
      body: Column(
        children: [
          Padding(
            padding:
                  ...
                  ElevatedButton(
                    onPressed: () {
                      utility.saveData(_textController, _youtubeUrlController,
                          _problemLinkController, _isFormVisible, 'coding_ninja');
                      setState(() {
          ...
          utility.show_data_coding(context, 'coding_ninja', Color(0xfffaae2a),
              Color(0xffffd285), _selectedDate, _searchText),
          Card(
            margin: EdgeInsets.all(16),
            child: ListTile(
              hoverColor: Color(0xfffaae2a),
              title: Center(child: Text('Visit Coding Ninja')),
              trailing: Icon(Icons.open_in_new),
              onTap: () =>
                  utility.launchURL('https://www.naukri.com/code360/profile/ffb5d91d-d195-45b1-a0c2-5c94729fd1a3'),
            ),
          ),
        ],
      ),
